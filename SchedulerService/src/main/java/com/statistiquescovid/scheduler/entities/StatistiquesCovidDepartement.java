package com.statistiquescovid.scheduler.entities;
...
@Document(collection = "Covid19_Departements_France")
public class StatistiquesCovidDepartement implements Serializable {
	...
	public StatistiquesCovidDepartement() {
		super();
	}
	public Date getDate() {
		return date;
	...
	public String toString() {
		return "StatistiquesCovidDepartement [dep=" + dep + ", date=" + date + ", reg=" + reg + ", lib_dep=" + lib_dep
				...
				+ ", dateEnregistrement=" + dateEnregistrement + ", dateModification=" + dateModification + "]";
	}
